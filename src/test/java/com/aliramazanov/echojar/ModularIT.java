...
class ModularIT {
        ...
        void aDriverOnTheModulePathDoesNotBringTheApplicationDown() throws Exception {
                ...
                Process target = new ProcessBuilder(
                                ...
                                "--module-path", driverJar.toString(),
                                "--add-modules", "org.hsqldb",
                ...
                assertTrue(findings.contains("8 executions in one connection lease"),
                                "the agent must still count through a named module:\n" + findings);
                assertTrue(findings.contains("ModularTarget"),
