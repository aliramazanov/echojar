 ...
 * and the command line tool. The agent's one job before anything else is to copy the counting code
 * into the bootstrap classloader, so that the code echojar adds to a driver can reach it from any
 * classloader.
 *
 ...
 * @see com.aliramazanov.echojar.bootstrap the counting code that the added code calls
 */
